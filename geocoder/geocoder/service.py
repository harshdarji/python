...
<head>
 ...
 var codesite_token = "22fLJQ70AbFAiXKlWzlg81RMeG8:1324030340267";
 
 
 var CS_env = {"profileUrl":["/u/105304908759851365046/"],"token":"22fLJQ70AbFAiXKlWzlg81RMeG8:1324030340267","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/16019714447707763395","projectHomeUrl":"/p/geocoder","relativeBaseUrl":"","projectName":"geocoder","loggedInUserEmail":"jeromecukier@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgeocoder%2Fsource%2Fbrowse%2Ftrunk%2Fgeocoder%2Fservice.py%3Fr%3D3" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/geocoder/source/browse/trunk/?r=3">trunk</a><span class="sp">/&nbsp;</span><a href="/p/geocoder/source/browse/trunk/geocoder/?r=3">geocoder</a><span class="sp">/&nbsp;</span>service.py</span>
 ...
 <a href="/p/geocoder/source/browse/trunk/geocoder/service.py?r=3&edit=1"
...
><td class="source">&quot;&quot;&quot;Defines the geocoder service interface.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svn3_16
...
><td class="source">class GeocodeAgainError(Error):<br></td></tr
><tr
id=sl_svn3_25
...
><td class="source">class NotFoundError(Error):<br></td></tr
><tr
id=sl_svn3_29
...
><td class="source">class Result(object):<br></td></tr
><tr
id=sl_svn3_33

><td class="source">  def __init__(self, lat, lon, meta=None):<br></td></tr
><tr
id=sl_svn3_34

><td class="source">    self.lat = lat<br></td></tr
><tr
id=sl_svn3_35

><td class="source">    self.lon = lon<br></td></tr
><tr
id=sl_svn3_36

><td class="source">    self.meta = meta<br></td></tr
><tr
id=sl_svn3_37
...
><td class="source">class GeocoderService(object):<br></td></tr
><tr
id=sl_svn3_40

><td class="source">  def geocode_address(self, address):<br></td></tr
><tr
id=sl_svn3_41

><td class="source">    &quot;&quot;&quot;Geocodes an address and returns a GeocodeResult if the address is found.<br></td></tr
><tr
id=sl_svn3_42

><td class="source">    Otherwise, throws an exception.<br></td></tr
><tr
id=sl_svn3_43
...
><td class="source">      A GeocodeResult detailing the result of the geocode.<br></td></tr
><tr
id=sl_svn3_46
...
><td class="source">      NotFoundError: The address wasn&#39;t found.<br></td></tr
><tr
id=sl_svn3_49

><td class="source">      GeocodeAgainError: The address could not be geocoded at this time and<br></td></tr
><tr
id=sl_svn3_50

><td class="source">          the geocode attempt should be retried.<br></td></tr
><tr
id=sl_svn3_51
...
<script type="text/javascript">
 ...
 by api.roman.public
 on Aug 14, 2009
 &nbsp; <a href="/p/geocoder/source/diff?spec=svn3&r=2&amp;format=side&amp;path=/trunk/geocoder/service.py&amp;old_path=/trunk/geocoder/service.py&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/geocoder/service.py';
 ...
 <a href="/p/geocoder/source/list?path=/trunk/geocoder/service.py&start=2">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//geocoder.googlecode.com/svn-history/r3/trunk/geocoder/service.py">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn3': '/trunk/geocoder/service.py'}
 codereviews = CR_controller.setup(
 {"profileUrl":["/u/105304908759851365046/"],"token":"22fLJQ70AbFAiXKlWzlg81RMeG8:1324030340267","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/16019714447707763395","projectHomeUrl":"/p/geocoder","relativeBaseUrl":"","projectName":"geocoder","loggedInUserEmail":"jeromecukier@gmail.com"}, '', 'svn3', paths,
