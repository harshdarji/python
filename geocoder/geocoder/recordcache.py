...
<head>
 ...
 var codesite_token = "B_BDN64ZWq3zmUEaZx3PNUxfMws:1324030337151";
 
 
 var CS_env = {"profileUrl":["/u/105304908759851365046/"],"token":"B_BDN64ZWq3zmUEaZx3PNUxfMws:1324030337151","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/16019714447707763395","projectHomeUrl":"/p/geocoder","relativeBaseUrl":"","projectName":"geocoder","loggedInUserEmail":"jeromecukier@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgeocoder%2Fsource%2Fbrowse%2Ftrunk%2Fgeocoder%2Frecordcache.py%3Fr%3D3" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/geocoder/source/browse/trunk/?r=3">trunk</a><span class="sp">/&nbsp;</span><a href="/p/geocoder/source/browse/trunk/geocoder/?r=3">geocoder</a><span class="sp">/&nbsp;</span>recordcache.py</span>
 ...
 <a href="/p/geocoder/source/browse/trunk/geocoder/recordcache.py?r=3&edit=1"
...
><td class="source">&quot;&quot;&quot;Defines an interface for record caches, which are designed to prevent<br></td></tr
><tr
id=sl_svn3_16

><td class="source">already-geocoded data records from being geocoded again unless they are<br></td></tr
><tr
id=sl_svn3_17

><td class="source">changed.<br></td></tr
><tr
id=sl_svn3_18
...
><td class="source">class Error(Exception):<br></td></tr
><tr
id=sl_svn3_24
...
><td class="source">class DoesNotExistError(Error):<br></td></tr
><tr
id=sl_svn3_28
...
><td class="source">class RecordCache(object):<br></td></tr
><tr
id=sl_svn3_32

><td class="source">  def get(id):<br></td></tr
><tr
id=sl_svn3_33

><td class="source">    &quot;&quot;&quot;Returns the record with the given ID from the record cache.<br></td></tr
><tr
id=sl_svn3_34
...
><td class="source">      A geocoder.data.Record with the given ID.<br></td></tr
><tr
id=sl_svn3_37
...
><td class="source">      A geocoder.recordcache.DoesNotExistError if no such record exists.<br></td></tr
><tr
id=sl_svn3_40
...
><td class="source">    raise NotImplementedError()<br></td></tr
><tr
id=sl_svn3_42
...
><td class="source">  def put(self, record, buffered=False):<br></td></tr
><tr
id=sl_svn3_44

><td class="source">    &quot;&quot;&quot;Puts the record to the record cache. When called with buffered=True<br></td></tr
><tr
id=sl_svn3_45

><td class="source">    on record caches that support buffering, queues to maximize throughput.<br></td></tr
><tr
id=sl_svn3_46

><td class="source">    Note that at the end of a sequence of buffered puts, the cache must manually<br></td></tr
><tr
id=sl_svn3_47

><td class="source">    be flush via flush().<br></td></tr
><tr
id=sl_svn3_48
...
><td class="source">  def flush(self):<br></td></tr
><tr
id=sl_svn3_52

><td class="source">    &quot;&quot;&quot;Flushes any remaining buffered put operations.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svn3_53
...
><td class="source">  def exists(self, id):<br></td></tr
><tr
id=sl_svn3_56

><td class="source">    &quot;&quot;&quot;Returns True if a record with the given ID exists in the record cache.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svn3_57
...
><td class="source">      rec = self.get(id)<br></td></tr
><tr
id=sl_svn3_59
...
><td class="source">    except DoesNotExistError:<br></td></tr
><tr
id=sl_svn3_61
...
><td class="source">  def changed(self, record):<br></td></tr
><tr
id=sl_svn3_64

><td class="source">    &quot;&quot;&quot;Returns True if the given record is either new or has changed since its<br></td></tr
><tr
id=sl_svn3_65

><td class="source">    last put to the record cache.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svn3_66
...
><td class="source">      current_record = self.get(record.id)<br></td></tr
><tr
id=sl_svn3_68

><td class="source">      return current_record == record<br></td></tr
><tr
id=sl_svn3_69
...
><td class="source">class DefaultRecordCache(RecordCache):<br></td></tr
><tr
id=sl_svn3_74

><td class="source">  &quot;&quot;&quot;A simple, in-memory implementation of a record cache.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svn3_75
...
><td class="source">    self._records = {}<br></td></tr
><tr
id=sl_svn3_78
...
><td class="source">  def get(self, id):<br></td></tr
><tr
id=sl_svn3_80
...
><td class="source">      return self._records[id]<br></td></tr
><tr
id=sl_svn3_82
...
><td class="source">      raise DoesNotExistError()<br></td></tr
><tr
id=sl_svn3_84
...
><td class="source">    self._records[id] = record<br></td></tr
><tr
id=sl_svn3_87
...
<script type="text/javascript">
 ...
 by api.roman.public
 on Aug 14, 2009
 &nbsp; <a href="/p/geocoder/source/diff?spec=svn3&r=2&amp;format=side&amp;path=/trunk/geocoder/recordcache.py&amp;old_path=/trunk/geocoder/recordcache.py&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/geocoder/recordcache.py';
 ...
 <a href="/p/geocoder/source/list?path=/trunk/geocoder/recordcache.py&start=2">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//geocoder.googlecode.com/svn-history/r3/trunk/geocoder/recordcache.py">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn3': '/trunk/geocoder/recordcache.py'}
 codereviews = CR_controller.setup(
 {"profileUrl":["/u/105304908759851365046/"],"token":"B_BDN64ZWq3zmUEaZx3PNUxfMws:1324030337151","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/16019714447707763395","projectHomeUrl":"/p/geocoder","relativeBaseUrl":"","projectName":"geocoder","loggedInUserEmail":"jeromecukier@gmail.com"}, '', 'svn3', paths,
