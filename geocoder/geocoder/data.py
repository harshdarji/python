...
<head>
 ...
 var codesite_token = "089PsJKV37ygfvXhTRrp-3gVTQg:1324030331226";
 
 
 var CS_env = {"profileUrl":["/u/105304908759851365046/"],"token":"089PsJKV37ygfvXhTRrp-3gVTQg:1324030331226","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/16019714447707763395","projectHomeUrl":"/p/geocoder","relativeBaseUrl":"","projectName":"geocoder","loggedInUserEmail":"jeromecukier@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgeocoder%2Fsource%2Fbrowse%2Ftrunk%2Fgeocoder%2Fdata.py%3Fr%3D3" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/geocoder/source/browse/trunk/?r=3">trunk</a><span class="sp">/&nbsp;</span><a href="/p/geocoder/source/browse/trunk/geocoder/?r=3">geocoder</a><span class="sp">/&nbsp;</span>data.py</span>
 ...
 <a href="/p/geocoder/source/browse/trunk/geocoder/data.py?r=3&edit=1"
...
><td class="source">&quot;&quot;&quot;Defines common data objects used throughout the batch geocoder library.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svn3_16
...
><td class="source">RECORD_FIELDS = [&#39;id&#39;, &#39;status&#39;, &#39;address&#39;, &#39;lat&#39;, &#39;lon&#39;, &#39;meta&#39;]<br></td></tr
><tr
id=sl_svn3_23
...
><td class="source">class Status(object):<br></td></tr
><tr
id=sl_svn3_26

><td class="source">  SUCCESS = 1<br></td></tr
><tr
id=sl_svn3_27

><td class="source">  NOT_FOUND = -1<br></td></tr
><tr
id=sl_svn3_28

><td class="source">  SERVER_ERROR = -2<br></td></tr
><tr
id=sl_svn3_29
...
><td class="source">class Record(object):<br></td></tr
><tr
id=sl_svn3_32

><td class="source">  &quot;&quot;&quot;Instances of this class represent a single address record that may or may<br></td></tr
><tr
id=sl_svn3_33

><td class="source">  not be geocoded.<br></td></tr
><tr
id=sl_svn3_34
...
><td class="source">    # Initialize record data fields to None.<br></td></tr
><tr
id=sl_svn3_38

><td class="source">    for field in RECORD_FIELDS:<br></td></tr
><tr
id=sl_svn3_39

><td class="source">      setattr(self, field, None)<br></td></tr
><tr
id=sl_svn3_40
...
><td class="source">    for kw in kwargs:<br></td></tr
><tr
id=sl_svn3_42

><td class="source">      setattr(self, kw, kwargs[kw])<br></td></tr
><tr
id=sl_svn3_43
...
><td class="source">    return md5.md5(pickle.dumps((id, address, status, lat, lon))).hexdigest()<br></td></tr
><tr
id=sl_svn3_46
...
><td class="source">  def as_dict(self):<br></td></tr
><tr
id=sl_svn3_48

><td class="source">    return dict((field, getattr(self, field) if hasattr(self, field) else None)<br></td></tr
><tr
id=sl_svn3_49
...
><td class="source">  def from_dict(dict_obj):<br></td></tr
><tr
id=sl_svn3_53

><td class="source">    return Record(**dict_obj)<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by api.roman.public
 on Aug 14, 2009
 &nbsp; <a href="/p/geocoder/source/diff?spec=svn3&r=2&amp;format=side&amp;path=/trunk/geocoder/data.py&amp;old_path=/trunk/geocoder/data.py&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/geocoder/data.py';
 ...
 <a href="/p/geocoder/source/list?path=/trunk/geocoder/data.py&start=2">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//geocoder.googlecode.com/svn-history/r3/trunk/geocoder/data.py">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn3': '/trunk/geocoder/data.py'}
 codereviews = CR_controller.setup(
 {"profileUrl":["/u/105304908759851365046/"],"token":"089PsJKV37ygfvXhTRrp-3gVTQg:1324030331226","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/16019714447707763395","projectHomeUrl":"/p/geocoder","relativeBaseUrl":"","projectName":"geocoder","loggedInUserEmail":"jeromecukier@gmail.com"}, '', 'svn3', paths,
