...
<head>
 ...
 var codesite_token = "pfUQlV0RbRfK-4cayJbi-jSkApU:1324030334256";
 
 
 var CS_env = {"profileUrl":["/u/105304908759851365046/"],"token":"pfUQlV0RbRfK-4cayJbi-jSkApU:1324030334256","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/16019714447707763395","projectHomeUrl":"/p/geocoder","relativeBaseUrl":"","projectName":"geocoder","loggedInUserEmail":"jeromecukier@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgeocoder%2Fsource%2Fbrowse%2Ftrunk%2Fgeocoder%2Fio.py%3Fr%3D3" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/geocoder/source/browse/trunk/?r=3">trunk</a><span class="sp">/&nbsp;</span><a href="/p/geocoder/source/browse/trunk/geocoder/?r=3">geocoder</a><span class="sp">/&nbsp;</span>io.py</span>
 ...
 <a href="/p/geocoder/source/browse/trunk/geocoder/io.py?r=3&edit=1"
...
><td class="source">&quot;&quot;&quot;Defines interfaces for input and output data record streams.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svn3_16
...
><td class="source">import csv<br></td></tr
><tr
id=sl_svn3_20

><td class="source">import pickle<br></td></tr
><tr
id=sl_svn3_21
...
><td class="source">from data import Record, Status<br></td></tr
><tr
id=sl_svn3_23
...
><td class="source">class InputRecordStream(object):<br></td></tr
><tr
id=sl_svn3_26

><td class="source">  &quot;&quot;&quot;Defines an abstract interface for input sources that can provide input<br></td></tr
><tr
id=sl_svn3_27

><td class="source">  records to the geocoder.<br></td></tr
><tr
id=sl_svn3_28
...
><td class="source">  def next(self):<br></td></tr
><tr
id=sl_svn3_34

><td class="source">    &quot;&quot;&quot;Returns the next record in the input stream.<br></td></tr
><tr
id=sl_svn3_35
...
><td class="source">      The next geocoder.data.Record in the stream.<br></td></tr
><tr
id=sl_svn3_38
...
><td class="source">      StopIteration: No more records were available.<br></td></tr
><tr
id=sl_svn3_41
...
><td class="source">  def eof(self):<br></td></tr
><tr
id=sl_svn3_45

><td class="source">    &quot;&quot;&quot;Returns True if all records have been read.&quot;&quot;&quot;<br></td></tr
><tr
id=sl_svn3_46
...
><td class="source">class OutputRecordStream(object):<br></td></tr
><tr
id=sl_svn3_50

><td class="source">  &quot;&quot;&quot;Defines an abstract interface for output sources that can accept output<br></td></tr
><tr
id=sl_svn3_51
...
><td class="source">  partial = False<br></td></tr
><tr
id=sl_svn3_55
...
><td class="source">  def put(self, rec):<br></td></tr
><tr
id=sl_svn3_57

><td class="source">    &quot;&quot;&quot;Writes a record to the output stream.<br></td></tr
><tr
id=sl_svn3_58
...
><td class="source">      rec: A geocoder.data.Record to write to the output stream.<br></td></tr
><tr
id=sl_svn3_61
...
<script type="text/javascript">
 ...
 by api.roman.public
 on Aug 14, 2009
 &nbsp; <a href="/p/geocoder/source/diff?spec=svn3&r=2&amp;format=side&amp;path=/trunk/geocoder/io.py&amp;old_path=/trunk/geocoder/io.py&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/geocoder/io.py';
 ...
 <a href="/p/geocoder/source/list?path=/trunk/geocoder/io.py&start=2">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//geocoder.googlecode.com/svn-history/r3/trunk/geocoder/io.py">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn3': '/trunk/geocoder/io.py'}
 codereviews = CR_controller.setup(
 {"profileUrl":["/u/105304908759851365046/"],"token":"pfUQlV0RbRfK-4cayJbi-jSkApU:1324030334256","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/16019714447707763395","projectHomeUrl":"/p/geocoder","relativeBaseUrl":"","projectName":"geocoder","loggedInUserEmail":"jeromecukier@gmail.com"}, '', 'svn3', paths,
