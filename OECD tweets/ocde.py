...
import json
import csv
urlStart="http://search.twitter.com/search.json?q=ocde&rpp=100&page="
dir="C:\\Documents and Settings\\cukier_j\\My Documents\\python\\OECD tweets\\"
tweets = []
cfgFile=open(dir+'cfgFileFr.txt','r')
...
tweetFile=open(dir+'tweetsfr.csv', 'ab')
