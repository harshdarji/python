...
var y1=d3.scale.linear().range([0,-15]).domain([0,.3]);
var y2=d3.scale.linear().range([0,15]).domain([0,.3]);
...
function updateC() {
	...
	page3.select(".unique").html(function() {return NLP[categories[cat3].short].unique;})
