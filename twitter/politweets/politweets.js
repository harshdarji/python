...
var fhR=bars.append("svg:rect").attr("width",13).attr("height",13).attr("x",1).attr("y",1)
	.style("stroke","none")
	.style("fill",function(d) {return fhd[d.critere][d.day]?pScale(fhd[d.critere][d.day]):pScale(0);})
	.attr("title",function(d) {return (fhd[d.critere][d.day]);})
var mlpR=bars.append("svg:rect").attr("width",13).attr("height",13).attr("x",1).attr("y",16)
	.style("stroke","none")
	.style("fill",function(d) {return mlpd[d.critere][d.day]?pScale(mlpd[d.critere][d.day]):pScale(0);})
	.attr("title",function(d) {return (mlpd[d.critere][d.day]);})
