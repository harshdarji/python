...
import os
import codecs
resultat=codecs.open("C:\\Documents and Settings\\cukier_j\\My Documents\\python\\parsingHTML\\resultat.txt","w","utf-8")
...
os.chdir("C:\Documents and Settings\cukier_j\My Documents\python\parsingHTML\PR2012")
